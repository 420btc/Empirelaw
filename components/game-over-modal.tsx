          ...
          <DialogDescription className="text-white text-center space-y-3">
            <div className="bg-red-800/50 p-4 rounded-lg border border-red-600">
              ...
              <p className="text-sm text-gray-300 mb-3">
                La estabilidad de <span className="font-bold text-red-400">{playerCountry}</span> cayó por debajo del 30%, 
            ...
            <div className="bg-yellow-900/30 p-3 rounded-lg border border-yellow-600">
              <p className="text-yellow-300 text-sm font-medium">
                💡 Consejo: Mantén la estabilidad por encima del 30% para evitar invasiones
              </p>
            </div>
          </DialogDescription>
        </DialogHeader>
